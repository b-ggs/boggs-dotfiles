...
files=".zshrc .vimrc .vim .tmuxinator .tmux.conf .fonts .oh-my-zsh .tmux-powerlinerc .i3 styleguide .Xdefaults .i3blocks.conf i3blocks lemonbar"        # list of files/folders to symlink in homedir
